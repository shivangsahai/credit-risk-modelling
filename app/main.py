...
with row1[1]:
    income = st.number_input('Income', min_value=0, value=100000, step=50000)
with row1[2]:
    loan_amount = st.number_input('Loan Amount', min_value=0, value=100000, step=50000)
...
with row3[2]:
    num_open_accounts = st.number_input('Open Loan Accounts', min_value=0, max_value=4, step=1, value=2)
